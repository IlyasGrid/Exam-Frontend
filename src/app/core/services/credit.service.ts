...
export class CreditService {
  ...
  getCreditsByClientId(clientId: number): Observable<CreditDTO[]> {
    ...
    return this.apiService.get<CreditDTO[]>(
  ...
  getCreditImmobilierById(id: number): Observable<CreditImmobilierDTO> {
    return this.apiService.get<CreditImmobilierDTO>(
      `${this.immobilierPath}/${id}`
    );
  }

  createCreditImmobilier(
    credit: CreditImmobilierDTO
  ): Observable<CreditImmobilierDTO> {
    return this.apiService.post<CreditImmobilierDTO, CreditImmobilierDTO>(
      this.immobilierPath,
      credit
    );
  }

  updateCreditImmobilier(
    credit: CreditImmobilierDTO
  ): Observable<CreditImmobilierDTO> {
    return this.apiService.put<CreditImmobilierDTO, CreditImmobilierDTO>(
      `${this.immobilierPath}/${credit.id}`,
      credit
    );
  }
  ...
  getCreditPersonnelById(id: number): Observable<CreditPersonnelDTO> {
    return this.apiService.get<CreditPersonnelDTO>(
      `${this.personnelPath}/${id}`
    );
  }

  createCreditPersonnel(
    credit: CreditPersonnelDTO
  ): Observable<CreditPersonnelDTO> {
    return this.apiService.post<CreditPersonnelDTO, CreditPersonnelDTO>(
      this.personnelPath,
      credit
    );
  }

  updateCreditPersonnel(
    credit: CreditPersonnelDTO
  ): Observable<CreditPersonnelDTO> {
    return this.apiService.put<CreditPersonnelDTO, CreditPersonnelDTO>(
      `${this.personnelPath}/${credit.id}`,
      credit
    );
  }
  ...
  getAllCreditsProfessionnel(): Observable<CreditProfessionnelDTO[]> {
    return this.apiService.get<CreditProfessionnelDTO[]>(
      this.professionnelPath
    );
  }

  getCreditProfessionnelById(id: number): Observable<CreditProfessionnelDTO> {
    return this.apiService.get<CreditProfessionnelDTO>(
      `${this.professionnelPath}/${id}`
    );
  }

  createCreditProfessionnel(
    credit: CreditProfessionnelDTO
  ): Observable<CreditProfessionnelDTO> {
    return this.apiService.post<CreditProfessionnelDTO, CreditProfessionnelDTO>(
      this.professionnelPath,
      credit
    );
  }

  updateCreditProfessionnel(
    credit: CreditProfessionnelDTO
  ): Observable<CreditProfessionnelDTO> {
    return this.apiService.put<CreditProfessionnelDTO, CreditProfessionnelDTO>(
      `${this.professionnelPath}/${credit.id}`,
      credit
    );
  }
